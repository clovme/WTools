...
echo. 选择更新源：
echo.
echo.  [1] Bebasid                  [2]-[5] Racaljk (稳定) 
echo.  [3] Go-Hosts + Racaljk       [6] Go-Hosts (包含4)
...
set ID=1
set /p ID=请输入选项(回车=1):
if /i %ID%==1 set "hosts0=https://github.com/bebasid/bebasin/raw/master/misc/hosts" && goto hostAD
...
if /i %ID%==6 set "hosts0=https://coding.net/u/idoog/p/HOSTS/git/raw/master/hosts" && goto hostAD
